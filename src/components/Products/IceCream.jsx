...
const IceCream = () => {
  ...
  return (
    <div>
     <div className=' flex justify-center items-center pt-30 text-4xl font-bold bg-linear-to-r from-red-500 to-blue-900 bg-clip-text text-transparent '><h1>Ice-Cream</h1></div>
