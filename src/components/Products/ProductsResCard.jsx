...
const ProductsResCard = ({resData}) => {
    
  const { name, cuisines, avgRating,cloudinaryImageId, costForTwo, sla} = resData?.card?.card?.info;
      ...
      <div>
            <div className="card w-60 rounded-lg flex flex-col gap-6 h-80 hover:scale-96 transition-transform duration-150 mb-8 cursor-pointer">
              ...
              <div className="flex flex-col items-start gap-1">
                ...
                <h4 className=" text-gray-500">Delivery in: {sla.deliveryTime} minutes</h4>
...
export default ProductsResCard
